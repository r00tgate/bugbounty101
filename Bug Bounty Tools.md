...
http://www.portswigger.net/burp/intruder.html – Burp Intruder is a Web Application Security Tools for automating customized attacks against web apps.
...
https://github.com/WangYihang/Webshell-Sniper – Manage your webshell via terminal.   * https://github.com/DanMcInerney/dnsspoof – DNS spoofer. Drops DNS responses from the router and replaces it with the spoofed DNS response
